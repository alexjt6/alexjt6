...
My current tech stack includes **Java, Python, PHP, JavaScript, React, HTML/CSS**, and databases like **SQL (PostgreSQL & MariaDB)**. 
...
* 🛠️ Currently learning: **PHP**, database management with **SQL**, and building simple websites with **React**.
